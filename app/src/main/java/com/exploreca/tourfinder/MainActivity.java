...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		File extDir = getExternalFilesDir(null);  // null is for root directory
		String path = extDir.getAbsolutePath();
		UIHelper.displayText(this, R.id.textView1, path);

		file = new File(extDir, FILENAME);   // Directory and file name
	...
	public Boolean checkExternalStorage (){
		...
		if (state.equals(Environment.MEDIA_MOUNTED)) {
			...
			UIHelper.displayText(this, R.id.textView1, "Read only media");
			return false;
		} else {
			UIHelper.displayText(this, R.id.textView1, "External storage unavailable");
			return false;
		}
	}
}
